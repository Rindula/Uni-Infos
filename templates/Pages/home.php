...
<div style="text-align: center">
    <?= $this->Html->link(__("To file storage"), 'https://files.rindula.de/nextcloud/index.php/s/TqWQwraiBN3JJoZ', ['class' => 'button button-outline', 'target' => '_blank']) ?>
    <?= $this->Html->link(__("To the timetable"), ['controller' => 'stundenplan', 'action' => 'index'], ['class' => 'button button-clear']) ?>
    <?= $this->Html->link(__("Session recordings"), 'https://files.rindula.de/nextcloud/index.php/s/z4mi9YMsr74s3AQ', ['class' => 'button button-outline', 'target' => '_blank']) ?>
    <br>
